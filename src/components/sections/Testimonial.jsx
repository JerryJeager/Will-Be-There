...
export const testimonialData = [
  {
    id: 1,
    comment:
      "Since using Will Be There, the quality of our guest invite process has improved drastically. The user-friendly interface allows even non-designers like myself to create professional-looking Invite. It's a fantastic tool for any business looking to improve their Event process.",
    name: "Donald Duke",
  ...
  return (
    <section>
      <div className="flex flex-col items-center justify-center text-center py-5 sm:p-10">
        ...
        <div
          id="slider"
          className="w-full h-full overflow-x-auto whitespace-nowrap scrollbar-hide scroll-smooth relative py-10 transition-all"
        >
