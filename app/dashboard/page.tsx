...
const Dashboard = () => {
  ...
  return (
    <main className='w-full col-span-10 flex flex-col px-24 py-8 bg-[#F2EFF7] flex-grow'>
      <header className="">
        <h1 className='text-[#777680] text-2xl'>Welcome, {session.user.name}.</h1>
      </header>
           
...
const mockData = [
  { id: '1jkdjfieiaadfa', thumbnail: 'https://images.pexels.com/photos/1071879/pexels-photo-1071879.jpeg?auto=compress&cs=tinysrgb&w=800', title: 'Stephanie\'s Wedding Invitation', description: 'Join Stephanie and David as they tie the knot under a canopy of wisteria, followed by an evening of dancing and delicious food under the Tuscan sun.', date: '2024-05-01', time: '11AM', location: 'New York', slug: '/invitation/1jkdjfieiaadfa', },
  {id: '2jkdjfieiaadfa', thumbnail: 'https://images.pexels.com/photos/7723715/pexels-photo-7723715.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2', title: 'Homewarming Party', description: 'Get ready to dance the night away and reconnect with old friends at our lively Homecoming Bash', date: '2024-05-15', time: '2PM', location: 'San Francisco', slug: '/invitation/2jkdjfieiaadfa'}
]
