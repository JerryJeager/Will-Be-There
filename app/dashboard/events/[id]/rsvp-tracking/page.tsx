    ...
    guestList: [
        {
            ...
            status: 'attending',
            plusOnes: ['Hassan Ibrahim', 'Amelia Jones', 'Carlos Silva']
        },
        {
            id: 2,
            name: 'Akira Tanaka',
            ...
            plusOnes: ['Sophia Kim', 'Fatima Ali']
        },
        {
            id: 3,
        ...
        },
        {
            ...
            status: 'pending',
            plusOnes: ['Mohammed Ahmed', 'Alejandro Lopez']
        },
        {
            id: 5,
            name: 'Emily Johnson',
            ...
            status: 'attending',
            plusOnes: ['Sophie Martin', 'Ahmed Hassan', 'Mia Thompson']
        },
        {
            id: 6,
            name: 'Maha Khalifa',
            ...
            status: 'not attending',
            plusOnes: ['Aaliyah Brown', 'Daniel Garcia', 'Maria Lopez']
        },
        {
            id: 7,
            name: 'Marcelo Lopez',
        ...
        },
        {
            ...
            status: 'pending',
            plusOnes: ['Olivia Rodriguez', 'Liam Martinez', 'Yara Nasser']
        },
        {
            id: 9,
            name: 'Moses Osei',
